@extends('layouts.app')
@section('title', 'Edit Paket Pricing')
@section('page-title', 'Edit Paket Pricing')
@section('breadcrumb')
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('pricing-plans.update', $pricingPlan) }}" method="POST">
            @csrf @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" 
                               value="{{ old('price', $pricingPlan->price) }}" min="0" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="badge_color" class="form-control @error('badge_color') is-invalid @enderror" required>
                            <option value="primary" {{ old('badge_color', $pricingPlan->badge_color) == 'primary' ? 'selected' : '' }}>Primary (Biru)</option>
                            <option value="success" {{ old('badge_color', $pricingPlan->badge_color) == 'success' ? 'selected' : '' }}>Success (Hijau)</option>
                            <option value="warning" {{ old('badge_color', $pricingPlan->badge_color) == 'warning' ? 'selected' : '' }}>Warning (Kuning)</option>
                            <option value="danger" {{ old('badge_color', $pricingPlan->badge_color) == 'danger' ? 'selected' : '' }}>Danger (Merah)</option>
                            <option value="info" {{ old('badge_color', $pricingPlan->badge_color) == 'info' ? 'selected' : '' }}>Info (Cyan)</option>
                            <option value="secondary" {{ old('badge_color', $pricingPlan->badge_color) == 'secondary' ? 'selected' : '' }}>Secondary (Abu)</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_invitations" class="form-control @error('max_invitations') is-invalid @enderror" 
                               value="{{ old('max_invitations', $pricingPlan->max_invitations) }}" min="1" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_gallery_photos" class="form-control @error('max_gallery_photos') is-invalid @enderror" 
                               value="{{ old('max_gallery_photos', $pricingPlan->max_gallery_photos) }}" min="0" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_music_uploads" class="form-control @error('max_music_uploads') is-invalid @enderror" 
                               value="{{ old('max_music_uploads', $pricingPlan->max_music_uploads) }}" min="0" required>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input type="checkbox" name="gift_section_included" value="1" 
                           ...
                           {{ old('gift_section_included', $pricingPlan->gift_section_included) ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input type="checkbox" name="can_delete_music" value="1" 
                           ...
                           {{ old('can_delete_music', $pricingPlan->can_delete_music) ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                <div id="features-container">
                    @php $features = old('features', $pricingPlan->features ?? []); @endphp
                    @if(count($features) > 0)
