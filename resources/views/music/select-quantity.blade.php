        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    {{-- Form Pilih Jumlah --}}
                    <form action="{{ route('music.slots.checkout') }}" method="GET">
                        ...
                        <div class="card bg-light mb-4">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <strong>Rp {{ number_format($pricePerSlot, 0, ',', '.') }}</strong>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <strong class="text-primary fs-5" id="displayTotal">Rp {{ number_format(1 * $pricePerSlot, 0, ',', '.') }}</strong>
                                </div>
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('music.upload') }}" class="btn btn-secondary">
...
<script>
const pricePerSlot = {{ $pricePerSlot }};
