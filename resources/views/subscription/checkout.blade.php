    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header text-center bg-primary text-white">
                <h4 class="card-title mb-0">Pembayaran Paket {{ $plan->name }}</h4>
            </div>
            <div class="card-body">
                {{-- Order Summary --}}
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr class="table-active">
                                ...
                                <td class="fw-bold text-success fs-5">Rp {{ number_format($plan->price, 0, ',', '.') }}</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="nav nav-tabs payment-method-tabs mb-3" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $hasActiveVA || !$hasAnyActivePayment ? 'active' : '' }} {{ $hasAnyActivePayment && !$hasActiveVA ? 'disabled' : '' }}" 
                                        id="va-tab" 
                                        data-bs-toggle="tab" 
                                        data-bs-target="#va-content" 
                                        type="button" 
                                        role="tab"
                                        {{ $hasAnyActivePayment && !$hasActiveVA ? 'disabled' : '' }}>
                                    <i class="fa fa-university"></i> Virtual Account
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $hasActiveEWallet ? 'active' : '' }} {{ $hasAnyActivePayment && !$hasActiveEWallet ? 'disabled' : '' }}" 
                                        id="ewallet-tab" 
                                        data-bs-toggle="tab" 
                                        data-bs-target="#ewallet-content" 
                                        type="button" 
                                        role="tab"
                                        {{ $hasAnyActivePayment && !$hasActiveEWallet ? 'disabled' : '' }}>
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $hasActiveQris ? 'active' : '' }} {{ $hasAnyActivePayment && !$hasActiveQris ? 'disabled' : '' }}" 
                                        ...
                                        type="button" 
                                        role="tab"
                                        {{ $hasAnyActivePayment && !$hasActiveQris ? 'disabled' : '' }}>
                        ...
                        <div class="tab-content">
                            {{-- Virtual Account Tab --}}
                            <div class="tab-pane fade {{ $hasActiveVA || !$hasAnyActivePayment ? 'show active' : '' }}" id="va-content" role="tabpanel">
                                @if(isset($virtualAccount) && $virtualAccount)
                                ...
                                <div class="alert alert-success">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" class="form-control fw-bold text-center" 
                                                   value="{{ $virtualAccount->display_va_number }}" 
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="fw-bold text-danger fs-6">
                                            {{ $virtualAccount->expired_at->format('d M Y H:i') }} WIB
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('subscription.create-va', $order) }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="channel" class="form-select" required>
                                                    ...
                                                    @foreach(\App\Services\DokuVirtualAccountService::getAvailableChannels() as $code => $name)
                            ...
                            {{-- E-Wallet Tab --}}
                            <div class="tab-pane fade {{ $hasActiveEWallet ? 'show active' : '' }}" id="ewallet-content" role="tabpanel">
                                @if(isset($ewalletPayment) && $ewalletPayment)
                                ...
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="fw-bold">{{ $ewalletPayment->channel_name }}</div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="text-muted small">Jumlah</label>
                                            <div class="fw-bold text-success fs-5">{{ $ewalletPayment->formatted_amount }}</div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="text-muted small">Status</label>
                                            <div>
                                                @if($ewalletPayment->status === 'processing')
                                                    <span class="badge bg-warning">Menunggu Pembayaran</span>
                                                @elseif($ewalletPayment->status === 'success')
                                                    <span class="badge bg-success">Berhasil</span>
                                                @else
                                                    <span class="badge bg-secondary">{{ ucfirst($ewalletPayment->status) }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        @if($ewalletPayment->web_redirect_url)
                                        <a href="{{ $ewalletPayment->web_redirect_url }}" class="btn btn-primary w-100 mb-2" target="_blank">
                                        ...
                                        <a href="{{ route('subscription.checkout', $order->plan) }}" class="btn btn-secondary w-100 mb-2">
                                            <i class="fa fa-refresh"></i> Coba Lagi
                                        </a>
                                        @endif
                                        <div class="alert alert-info small mt-3 mb-0">
                                            <i class="fa fa-clock"></i>
                                            Berlaku sampai: <strong>{{ $ewalletPayment->expired_at->format('d M Y H:i') }} WIB</strong>
                                        </div>
                                    </div>
                                </div>
                                @else
                                {{-- Create E-Wallet Payment Form --}}
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0">Pilih E-Wallet</h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('subscription.create-ewallet', $order) }}" method="POST" id="ewallet-form">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @foreach(\App\Services\DokuEWalletService::getAvailableChannels() as $code => $info)
                                                <div class="ewallet-btn" onclick="selectEWallet('{{ $code }}')">
                                                    <div style="width: 50px; height: 30px; background: #f0f0f0; border-radius: 4px; display: flex; align-items: center; justify-content: center; margin-right: 10px;">
                                                        <span style="font-size: 12px; font-weight: bold;">
                                                            @if($code === 'EMONEY_SHOPEE_PAY_SNAP')
                                                                🛒
                                                            @elseif($code === 'EMONEY_DANA_SNAP')
                                                                💰
                                                            @else
                                                                💳
                                                            @endif
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div class="ewallet-name">{{ $info['name'] }}</div>
                            ...
                            {{-- QRIS Tab --}}
                            <div class="tab-pane fade {{ $hasActiveQris ? 'show active' : '' }}" id="qris-content" role="tabpanel">
                                @if(isset($qrisPayment) && $qrisPayment)
                                {{-- QRIS Payment Info --}}
                                <div class="card border-primary">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mb-3">
                                            <label class="text-muted small">Status</label>
                                            <div>
                                                @if($qrisPayment->status === 'pending')
                                                    <span class="badge bg-warning">Menunggu Pembayaran</span>
                                                @elseif($qrisPayment->status === 'paid')
                                                    <span class="badge bg-success">Berhasil</span>
                                                @else
                                                    <span class="badge bg-secondary">{{ ucfirst($qrisPayment->status) }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-warning small mb-3">
                                            <i class="fa fa-clock"></i>
                                            Berlaku sampai: <strong>{{ $qrisPayment->expired_at->format('d M Y H:i') }} WIB</strong>
                                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <ol class="mb-0 ps-3">
                            ...
                            <li>Pilih <strong>Bank 
                                ...
                                @endphp
                                {{ $bankName }}</strong></li>
                            <li>Masukkan nomor VA: <strong>{{ $virtualAccount->display_va_number }}</strong></li>
                            <li>Masukkan jumlah: <strong>Rp {{ number_format($virtualAccount->amount, 0, ',', '.') }}</strong></li>
...
function checkPaymentStatus() {
    ...
    // Call API
    fetch('{{ route("api.payment.check-va-status") }}', {
        method: 'POST',
        headers: {
...
@if(isset($qrisPayment) && $qrisPayment && $qrisPayment->qr_content)
// Generate QR Code using qrcodejs
document.addEventListener('DOMContentLoaded', function() {
    new QRCode(document.getElementById("qrcode"), {
        text: "{{ $qrisPayment->qr_content }}",
        width: 256,
        height: 256,
        colorDark : "#000000",
        colorLight : "#ffffff",
...
function checkQrisStatus() {
    ...
    fetch('{{ route("api.payment.check-qris-status") }}', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '{{ csrf_token() }}',
...
document.getElementById('qris-form')?.addEventListener('submit', function(e) {
    ...
    // Make AJAX request
    fetch('{{ route("subscription.create-qris", $order) }}', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '{{ csrf_token() }}',
