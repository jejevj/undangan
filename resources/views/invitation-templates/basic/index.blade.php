...
{{-- ── GALERI ────────────────────────────────────────────────────── --}}
@include('invitation-templates._gallery', ['sectionClass' => 'section-alt', 'galleryColumns' => 2])

{{-- ── GIFT SECTION ──────────────────────────────────────────────── --}}
@include('invitation-templates._gift', ['giftSectionClass' => 'section-alt'])

{{-- ── FOOTER ────────────────────────────────────────────────────── --}}
<footer class="inv-footer">    <p>{{ $invitation->title }}</p>
...
<script src="{{ asset('invitation-assets/basic/js/app.js') }}"></script>
</body>
</html>
