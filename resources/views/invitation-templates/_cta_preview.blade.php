{{--
    CTA Button untuk Preview Templates
    Hanya muncul di preview public (slug berakhiran -preview)
--}}
@if(str_ends_with($invitation->slug, '-preview'))
<div class="preview-cta-wrapper">
    <a href="{{ route('register') }}" class="preview-cta-button">
