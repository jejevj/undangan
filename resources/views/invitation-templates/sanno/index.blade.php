...
<head>
    ...
    {{-- SEO Meta Tags --}}
    <meta name="description" content="{{ $data['event_title'] ?? 'Undangan Acara' }} - {{ $data['event_description'] ?? '' }}">
    ...
    <meta property="og:description" content="{{ $data['event_title'] ?? 'Undangan Acara' }}">
    <meta property="og:url" content="{{ url()->current() }}">
    @if(!empty($data['cover_photo']))
    <meta property="og:image" content="{{ asset('storage/' . $data['cover_photo']) }}">
    @endif
    ...
    <div class="event-card-wrap">
        <div class="event-card">
            ...
            @if(!empty($data['maps_url']))
                <a href="{{ $data['maps_url'] }}" target="_blank" rel="noopener" class="btn-primary">
...
<section id="countdown-section" class="section section-alt reveal">
    ...
    <div class="countdown" id="countdown"
         data-date="{{ $data['event_date'] }} {{ $data['event_time'] ?? '00:00' }}"></div>
</section>
@endif
...
<footer class="inv-footer">
    ...
    <div class="footer-logo">
        <img src="{{ asset('storage/' . $data['company_logo']) }}" alt="Logo" style="max-width: 100%; filter: brightness(0) invert(1); opacity: .3;">
    </div>
    @endif
