    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.campaigns.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <small class="form-text text-info">URL: <?php echo e(route('register')); ?>?ref=<strong id="code-preview">KODE</strong></small>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="pricing_plan_id" id="pricing_plan_id" class="form-control <?php $__errorArgs = ['pricing_plan_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="<?php echo e($plan->id); ?>" <?php echo e(old('pricing_plan_id') == $plan->id ? 'selected' : ''); ?>>
                                    <?php echo e($plan->name); ?> - Rp <?php echo e(number_format($plan->price, 0, ',', '.')); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="max_users" id="max_users" class="form-control <?php $__errorArgs = ['max_users'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('max_users', 10)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <a href="<?php echo e(route('admin.campaigns.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\idorganizer\undangan\resources\views/admin/campaigns/create.blade.php ENDPATH**/ ?>