...
<head>
    ...
    <link href="<?php echo e(asset('invitation-assets/basic/css/style.css')); ?>" rel="stylesheet">
    ...
    <div class="hero-inner reveal">
        ...
        <h1 class="hero-names">
            <span data-editable
                  ...
                  data-field-label="Nama Mempelai Pria"><?php echo e($data['groom_nickname'] ?? $data['groom_name'] ?? 'Mempelai Pria'); ?></span>
            <span class="hero-ampersand">&</span>
            <span data-editable
                  data-field-key="bride_name"
                  data-field-type="text"
                  data-field-label="Nama Mempelai Wanita"><?php echo e($data['bride_nickname'] ?? $data['bride_name'] ?? 'Mempelai Wanita'); ?></span>
        </h1>
        <?php if(!empty($data['akad_date'])): ?>
            <p class="hero-date"
               ...
               data-field-label="Tanggal Akad"><?php echo e(\Carbon\Carbon::parse($data['akad_date'])->translatedFormat('d F Y')); ?></p>
        <?php endif; ?>
    </div>
</section>
    ...
    <div class="couple-grid">
        <div>
            ...
            <div class="couple-name"
                 ...
                 data-field-key="groom_name"
                 data-field-type="text"
                 data-field-label="Nama Lengkap Pria"><?php echo e($data['groom_name'] ?? '-'); ?></div>
            <div class="couple-parents">
                Putra dari<br>
                <span data-editable
                      data-field-key="groom_father"
                      data-field-type="text"
                      data-field-label="Nama Ayah Pria"><?php echo e($data['groom_father'] ?? ''); ?></span>
                <?php if(!empty($data['groom_father']) && !empty($data['groom_mother'])): ?> & <?php endif; ?>
                <span data-editable
                      data-field-key="groom_mother"
                      data-field-type="text"
                      data-field-label="Nama Ibu Pria"><?php echo e($data['groom_mother'] ?? ''); ?></span>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="couple-name"
                 ...
                 data-field-key="bride_name"
                 data-field-type="text"
                 data-field-label="Nama Lengkap Wanita"><?php echo e($data['bride_name'] ?? '-'); ?></div>
            <div class="couple-parents">
                Putri dari<br>
                <span data-editable
                      data-field-key="bride_father"
                      data-field-type="text"
                      data-field-label="Nama Ayah Wanita"><?php echo e($data['bride_father'] ?? ''); ?></span>
                <?php if(!empty($data['bride_father']) && !empty($data['bride_mother'])): ?> & <?php endif; ?>
                <span data-editable
                      data-field-key="bride_mother"
                      data-field-type="text"
                      data-field-label="Nama Ibu Wanita"><?php echo e($data['bride_mother'] ?? ''); ?></span>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="event-card">
            ...
            <?php if(!empty($data['akad_date'])): ?>
                <div class="event-date"
                     ...
                     data-field-key="akad_date"
                     data-field-type="date"
                     data-field-label="Tanggal Akad"><?php echo e(\Carbon\Carbon::parse($data['akad_date'])->translatedFormat('l, d F Y')); ?></div>
            <?php endif; ?>
            <?php if(!empty($data['akad_time'])): ?>
                <div class="event-time"
                     ...
                     data-field-label="Waktu Akad"><?php echo e($data['akad_time']); ?> WIB</div>
            <?php endif; ?>
            <div class="event-venue"
                 data-editable
                 data-field-key="akad_venue"
                 data-field-type="text"
                 data-field-label="Tempat Akad"><?php echo e($data['akad_venue'] ?? ''); ?></div>
        </div>
        <div class="event-card">
            <h3>Resepsi</h3>
            <?php if(!empty($data['reception_date'])): ?>
                <div class="event-date"
                     ...
                     data-field-type="date"
                     data-field-label="Tanggal Resepsi"><?php echo e(\Carbon\Carbon::parse($data['reception_date'])->translatedFormat('l, d F Y')); ?></div>
            <?php endif; ?>
            <?php if(!empty($data['reception_time'])): ?>
                <div class="event-time"
                     ...
                     data-field-type="time"
                     data-field-label="Waktu Resepsi"><?php echo e($data['reception_time']); ?> WIB</div>
            <?php endif; ?>
            <div class="event-venue"
                 data-editable
                 data-field-key="reception_venue"
                 data-field-type="text"
                 data-field-label="Tempat Resepsi"><?php echo e($data['reception_venue'] ?? ''); ?></div>
        </div>
    </div>
    <?php if(!empty($data['maps_url'])): ?>
        <a href="<?php echo e($data['maps_url']); ?>" target="_blank" rel="noopener" class="btn-primary-inv">
...
<?php echo $__env->make('invitation-templates._gallery', ['sectionClass' => 'section-alt', 'galleryColumns' => 2], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>


<?php echo $__env->make('invitation-templates._gift', ['giftSectionClass' => 'section-alt'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>


<footer class="inv-footer">    <p><?php echo e($invitation->title); ?></p>
    <p style="margin-top:6px;opacity:.5;font-size:.75rem">Dibuat dengan ❤ menggunakan sistem undangan digital</p>
</footer>
...
<button class="music-fab playing" id="musicFab" aria-label="Play/Pause musik">
    <svg class="icon-disc" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3v10.55A4 4 0 1 0 14 17V7h4V3h-6z"/></svg>
...
<script src="<?php echo e(asset('invitation-assets/basic/js/app.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\laragon\www\idorganizer\undangan\resources\views/invitation-templates/basic/index.blade.php ENDPATH**/ ?>