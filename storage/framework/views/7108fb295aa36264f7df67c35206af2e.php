        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <div class="mode-selector">
                    <div class="mode-card <?php echo e($invitation->love_story_mode === 'longtext' ? 'active' : ''); ?>" 
                         onclick="selectLoveStoryMode('longtext', <?php echo e($invitation->canUseTimelineMode() ? 'true' : 'false'); ?>)">
                    ...
                    <div class="mode-card <?php echo e($invitation->love_story_mode === 'timeline' ? 'active' : ''); ?> <?php echo e(!$invitation->canUseTimelineMode() ? 'disabled' : ''); ?>" 
                         onclick="selectLoveStoryMode('timeline', <?php echo e($invitation->canUseTimelineMode() ? 'true' : 'false'); ?>)">
                        <?php if(!$invitation->canUseTimelineMode()): ?>
            ...
            <div id="loveStoryContent">
                <?php if($invitation->love_story_mode === 'longtext'): ?>
                ...
                <?php else: ?>
                    ...
                    <?php if($invitation->loveStoryTimeline->isEmpty()): ?>
                        ...
                        <div id="timelineList">
                            ...
                            <?php $__currentLoopData = $invitation->loveStoryTimeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($item->is_timeskip && $item->timeskip_label): ?>
                                    ...
                                    <div class="timeline-timeskip" data-id="<?php echo e($item->id); ?>" data-type="timeskip">
                                        <span class="timeskip-drag-handle">⋮⋮</span>
                                        <div class="timeskip-line"></div>
                                        <div class="timeskip-label"><?php echo e($item->timeskip_label); ?></div>
                                        <div class="timeskip-line"></div>
                                        <div class="timeline-actions" style="justify-content:center;margin-top:8px;">
                                            <button type="button" class="btn btn-sm btn-outline-primary" 
                                                    onclick="editTimeline(<?php echo e($item->id); ?>, '<?php echo e($item->sender); ?>', `<?php echo e(addslashes($item->message)); ?>`, <?php echo e($item->is_timeskip ? 'true' : 'false'); ?>, `<?php echo e(addslashes($item->timeskip_label ?? '')); ?>`, '<?php echo e($item->event_date ? $item->event_date->format('Y-m-d') : ''); ?>', '<?php echo e($item->event_time); ?>')">
                                                <i class="fa fa-edit"></i> Edit
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteTimeline(<?php echo e($item->id); ?>)">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="timeline-item <?php echo e($item->isFromBride() ? 'from-bride' : 'from-groom'); ?> <?php echo e(!$showAvatar ? 'no-avatar' : ''); ?>" data-id="<?php echo e($item->id); ?>" data-type="message">
                                            ...
                                            <?php if($showAvatar): ?>
                                                <div class="timeline-header">
                                                    <span class="timeline-sender">
                                                        <?php echo e($item->isFromGroom() ? 'Mempelai Pria' : 'Mempelai Wanita'); ?>

                                                    </span>
                                                    <span class="timeline-date">
                                                        <?php echo e($item->formatted_date_time); ?>

                                                    </span>
                                                </div>
                                            <?php endif; ?>
                                            <div class="timeline-message"><?php echo e($item->message); ?></div>
...
<script src="<?php echo e(asset('assets/js/love-story-timeline.js')); ?>"></script>
<script>
// Initialize timeline handler when DOM is ready
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', function() {
        LoveStoryTimeline.init(<?php echo e($invitation->id); ?>);
...
function updateTimelineOrder(timelineIds) {
    var invitationId = <?php echo e($invitation->id); ?>;
...
window.selectLoveStoryMode = function(mode, canUseTimeline) {
    ...
    form.method = 'POST';
    form.action = '<?php echo e(route('invitations.love-story.switch-mode', $invitation)); ?>';
