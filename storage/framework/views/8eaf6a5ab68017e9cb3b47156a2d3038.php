...
<div class="row g-3 mb-3">
    <div class="col-md-4">
        <div class="stat-card primary">
            ...
            <h2 class="text-primary"><?php echo e($subscriptionConversion); ?>%</h2>
    ...
    <div class="col-md-4">
        <div class="stat-card success">
            ...
            <h2 class="text-success"><?php echo e($invitationConversion); ?>%</h2>
    ...
    <div class="col-md-4">
        <div class="stat-card info">
            ...
            <h2 class="text-info"><?php echo e($registrationConversion); ?>%</h2>
...
<?php if(count($subscriptionFunnel) > 0 && $subscriptionFunnel[0]['count'] > 0): ?>
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="funnel-step">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                <div>
                    <strong style="font-size: 14px;"><?php echo e($index + 1); ?>. <?php echo e($step['label']); ?></strong>
...
<?php if(count($invitationFunnel) > 0 && $invitationFunnel[0]['count'] > 0): ?>
<div class="card mb-3">
    <div class="card-header py-2">
    ...
    <div class="card-body">
        ...
        <div class="funnel-step">
            ...
            <div class="funnel-bar green" style="width: <?php echo e($step['count'] > 0 ? ($step['count'] / $invitationFunnel[0]['count'] * 100) : 0); ?>%">
                <?php echo e(number_format($step['count'])); ?>
...
<?php if(count($registrationFunnel) > 0 && $registrationFunnel[0]['count'] > 0): ?>
<div class="card mb-3">
    <div class="card-header py-2">
    ...
    <div class="card-body">
        ...
        <div class="funnel-step">
            ...
            <div class="funnel-bar cyan" style="width: <?php echo e($step['count'] > 0 ? ($step['count'] / $registrationFunnel[0]['count'] * 100) : 0); ?>%">
                <?php echo e(number_format($step['count'])); ?>
