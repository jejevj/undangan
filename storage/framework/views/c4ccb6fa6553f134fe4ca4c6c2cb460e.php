...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header"><h4 class="card-title">Form Edit User: <?php echo e($user->name); ?></h4></div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="pricing_plan_id" class="form-control <?php $__errorArgs = ['pricing_plan_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($plan->id); ?>"
                                    <?php echo e($activePlan && $activePlan->id === $plan->id ? 'selected' : ''); ?>>
                                    <?php echo e($plan->name); ?> - <?php echo e($plan->formattedPrice()); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('users.show', $user)); ?>" class="btn btn-info">Detail</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\idorganizer\undangan\resources\views/users/edit.blade.php ENDPATH**/ ?>