...
<body class="h-100">
    <a href="<?php echo e(route('landing')); ?>" class="back-to-home">
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <div class="text-center mb-4">
                                        ...
                                        ?>
                                        <?php if($logoDark): ?>
                                        <img src="<?php echo e(asset('storage/' . $logoDark)); ?>" alt="<?php echo e($siteName); ?>" class="auth-logo">
                                        <?php else: ?>
                                        <img src="<?php echo e(asset('assets/images/logo-full.png')); ?>" alt="<?php echo e($siteName); ?>" class="auth-logo">
                                        <?php endif; ?>
                                        
                                        <p class="auth-description">
                                            <?php echo e(\App\Models\GeneralConfig::get('site_description', 'Platform undangan online terlengkap untuk acara spesial Anda')); ?>
                                    ...
                                    <div class="auth-tabs">
                                        <a href="#" class="auth-tab <?php echo e(request()->routeIs('login') ? 'active' : ''); ?>" data-tab="login">
                                            Masuk
                                        </a>
