...
<head>
    ...
    ?>
    <title>Login & Registrasi - <?php echo e($siteName); ?></title>
        ...
        <div class="auth-left">
            <div class="auth-logo-section">
                <a href="<?php echo e(url('/')); ?>">
                    <?php if(\App\Models\GeneralConfig::get('logo_light')): ?>
                    <img src="<?php echo e(asset('storage/' . \App\Models\GeneralConfig::get('logo_light'))); ?>" alt="<?php echo e($siteName); ?>">
                    <?php else: ?>
            ...
            <div class="auth-form-container">
                ...
                <div class="mobile-logo">
                    <a href="<?php echo e(url('/')); ?>">
                        <?php if(\App\Models\GeneralConfig::get('logo_light')): ?>
                        <img src="<?php echo e(asset('storage/' . \App\Models\GeneralConfig::get('logo_light'))); ?>" alt="<?php echo e($siteName); ?>">
                        <?php elseif(\App\Models\GeneralConfig::get('logo_dark')): ?>
                        <img src="<?php echo e(asset('storage/' . \App\Models\GeneralConfig::get('logo_dark'))); ?>" alt="<?php echo e($siteName); ?>">
                        <?php else: ?>
                        <h1><?php echo e($siteName); ?></h1>
                        <?php endif; ?>
                    </a>
                ...
                <div class="auth-form-card">
                    ...
                    <div class="auth-tabs">
                        <a href="#" class="auth-tab <?php echo e(request()->routeIs('login') || !request()->routeIs('register') ? 'active' : ''); ?>" data-tab="login">
                            Masuk
                        </a>
                        <a href="#" class="auth-tab <?php echo e(request()->routeIs('register') ? 'active' : ''); ?>" data-tab="register">
                            Daftar
                        </a>
                    </div>
                    ...
                    <div id="login-tab" class="tab-content <?php echo e(request()->routeIs('login') || !request()->routeIs('register') ? 'active' : ''); ?>">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="nama@email.com" required autofocus>
                        </div>
                        <div class="form-group">
                ...
                <div id="register-tab" class="tab-content <?php echo e(request()->routeIs('register') ? 'active' : ''); ?>">
                    ...
                    <div class="campaign-alert">
                        ...
                        Anda mendapatkan akses <strong><?php echo e($campaign->pricingPlan->name); ?></strong> gratis dari kampanye <strong><?php echo e($campaign->name); ?></strong>
                        <?php if($campaign->max_users > 0): ?>
                        <small>Sisa kuota: <?php echo e($campaign->getRemainingSlots()); ?> dari <?php echo e($campaign->max_users); ?></small>
                        <?php endif; ?>
                    </div>
                    <?php elseif(isset($campaignWarning) && $campaignWarning): ?>
                    <div class="campaign-warning">
                        <strong>⚠️ Perhatian</strong>
                        <?php echo e($campaignWarning); ?>
                    ...
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <?php if(isset($campaign) && $campaign): ?>
                        <input type="hidden" name="campaign_code" value="<?php echo e($campaign->code); ?>">
                        <?php endif; ?>
                        
                        <div class="form-group">
                            <label>Nama Lengkap</label>
                            <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Nama lengkap Anda" required autofocus>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="nama@email.com" required>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tabs.forEach(tab => {
                tab.addEventListener('click', function(e) {
                    ...
                    const loginUrl = '<?php echo e(route("login")); ?>'.replace(/^http:/, window.location.protocol);
                    const registerUrl = '<?php echo e(route("register")); ?>'.replace(/^http:/, window.location.protocol);
...
<?php /**PATH C:\laragon\www\idorganizer\undangan\resources\views/auth/login.blade.php ENDPATH**/ ?>